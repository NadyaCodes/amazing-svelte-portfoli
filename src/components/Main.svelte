...
let steps = [
  {name: "Smoljames Store", icon: "fa-solid fa-cart-shopping", href: "#"},
  {name: "Ultimate Todos", icon: "fa-solid fa-list-check", href: "#"},
  {name: "Pokedex", icon: "fa-solid fa-diagram-project", href: "#"},
]

let benefits = [
  {name: "a self taught developer", description: "This is a description for the first thing"},
  {name: "a product design & UX finatic", description: "The second description"},
  {name: "an excellent communicator", description: "The third description"},
]
</script>
...
<div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
  <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">Hi! I'm <span class="poppins text-violet-400">Nadya</span> Corscadden <br />Full Stack <span class="poppins text-violet-400">Developer</span></h2>
<p class="text-base sm:text-lg md:text-xl">My <span class="text-violet-400">favorite tech</span> includes JavaScript (Next.js or SvelteKit), TailwindCSS, Node.js + Express.js, PostgreSQL or Prisma/Supabase</p>
...
<Step step={steps[0]}>
  <p>Smoljames Store is a merchandising store created with <strong class="text-violet-400">Next.js Commerce.js Stripe & Node.js + Express.js</strong> Commerce.js is a project CMS and Stripe is used for all transaction handling.</p>
</Step>
<Step step={steps[1]}>
  <p>Ultimate Tools is a Full Stack <strong class="text-violet-400">Next.js, Node.js + Express.js, Firebase</strong> CRUD application that allows users to login, manage a tidy and efficacious todo list, and persist this information across devices.</p>
...
<Step step={steps[2]}>
  ...
  <section id="about" class="py-10 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
...
<div class="flex flex-col gap-20 w-full mx-auto max-w-[800px]">
  ...
  <div class="flex gap-6 sm:gap-8"><p class="poppins text-4xl sm:text-5xl md:text-6xl text-slate-500 font-semibold">
    0{index + 1}
  </p>
